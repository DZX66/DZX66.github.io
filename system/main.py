        ...
        with open(os.path.join("../pages/",data[i]["title"]+".html"),"w",encoding="utf-8") as f:
            ...
            if data[i]["is_locked"]:
                with open(os.path.join("pages",data[i]["title"],"content.html"),"r",encoding="utf-8") as f1:
                    f.write(r'<!DOCTYPE html><html lang="zh-CN"><head><title>{title} - 柳下回声</title><link rel="stylesheet" type="text/css" href="../style.css?version=3"><script src="../system/crypto-js.min.js"></script><script src="../template.js?version=2"></script><meta name="viewport" content="width=device-width, initial-scale=1"><meta charset="utf-8"><meta name="referrer" content="no-referrer"></head><body><div id="left" class="card"><img src="https://cdnjson.com/images/2024/04/30/icon89fa04bb001fc658.png" style="max-width: 100%;"><a href="../blogs.html"><button style="float: right;margin-right: 1px;">返回</button></a></div><main id="main"><div class="title"><h1 style="margin-bottom: 0;">{title}</h1></div><div id="article-block" class="card"><div class="article" id="article"><div id="tip"><p>这个文档被加密了，需要密码...</p><p id="code" style="display:none;">{base64}</p><p>密码提示:{tip}</p><br/><span>密码：</span><input type="password" name="password" id="2"><button onclick="sure();">确定</button></div><div id="1"></div></div></div><aside class="card" id="aside"><span>最后一次编辑时间：{date}</span><br><span>创建时间：{create}</span><br><span>标签：{tags}</span><hr><a href="https://github.com/DZX66/DZX66.github.io/blob/main/system/pages/{title}/content.html" target="_blank">源文件</a><br><a href="https://github.com/DZX66/DZX66.github.io/commits/main/system/pages/{title}/content.html" target="_blank">编辑历史</a><hr><h3>目录</h3><div class="dir"></div></aside></main></body><script src="../decode.js"></script><script src="../self-adaption.js?version=1"></script></html>'.format(title=data[i]["title"],date=data[i]["last_edit_time"],create=data[i]["create_time"],base64=f1.read(),tags=tag,tip=data[i]["tip"]))
            else:
                with open(os.path.join("pages",data[i]["title"],"content.html"),"r",encoding="utf-8") as f1:
...
if __name__=="__main__":
    if is_admin():
        try:
            ...
            # 基础页面
            html = '<!DOCTYPE html><html lang="zh-CN"><head><title>{title} - 柳下回声</title><link rel="stylesheet" type="text/css" href="../style.css?version=3"><script src="../template.js?version=2"></script><meta name="viewport" content="width=device-width, initial-scale=1"><meta charset="utf-8"><meta name="referrer" content="no-referrer"></head><body><div id="left" class="card"><img src="https://cdnjson.com/images/2024/04/30/icon89fa04bb001fc658.png" style="max-width: 100%;"><a href="../blogs.html"><button style="float: right;margin-right: 1px;">返回</button></a></div><main id="main"><div class="title"><h1 style="margin-bottom: 0;">{title}</h1></div><div id="article-block" class="card"><div class="article" id="article">{content}</div></div><aside class="card" id="aside"><span>最后一次编辑时间：{date}</span><br><span>创建时间：{create}</span><br><span>标签：{tags}</span><hr><a href="https://github.com/DZX66/DZX66.github.io/blob/main/system/pages/{title}/content.html" target="_blank">源文件</a><br><a href="https://github.com/DZX66/DZX66.github.io/commits/main/system/pages/{title}/content.html" target="_blank">编辑历史</a><hr><h3>目录</h3><div class="dir"></div></aside></main></body><script>refresh();generateCatalog(".article", ".dir");</script><script src="../self-adaption.js?version=1"></script></html>'
            while True:
                print()
                cmd = None
